###########################################################################
## Makefile generated for component 'position_control_motor_sm'. 
## 
## Makefile     : position_control_motor_sm.mk
## Generated on : Wed Jul 17 14:43:31 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/position_control_motor_sm.elf
...
PRODUCT_NAME              = position_control_motor_sm
MAKEFILE                  = position_control_motor_sm.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = E:/edc/EDC_Project_Work_Marsico_Zito/position_control
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = position_control_motor_sm_comp.rsp
CMD_FILE                  = position_control_motor_sm.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/position_control_motor_sm.elf
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_SET_MTA_SUPPORT -DEXTMODE_XCP_TRIGGER_SUPPORT -DINTERNAL_XCP_MEM_BLOCK_1_SIZE=160 -DINTERNAL_XCP_MEM_BLOCK_1_NUMBER=1 -DINTERNAL_XCP_MEM_BLOCK_2_SIZE=168 -DINTERNAL_XCP_MEM_BLOCK_2_NUMBER=5 -DINTERNAL_XCP_MEM_BLOCK_3_SIZE=128 -DINTERNAL_XCP_MEM_BLOCK_3_NUMBER=5 -DINTERNAL_XCP_MEM_RESERVED_POOLS_TOTAL_SIZE=1804 -DINTERNAL_XCP_MEM_RESERVED_POOLS_NUMBER=6 -DXCP_MEM_DAQ_RESERVED_POOL_BLOCKS_NUMBER=3 -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=2 -DXCP_MIN_EVENT_NO_RESERVED_POOL=2 -DXCP_MAX_CTO_SIZE=255 -DXCP_MAX_DTO_SIZE=65532 -DXCP_MAX_ODT_ENTRY_SIZE=255 -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=2000 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0
...
DEFINES_STANDARD = -DMODEL=position_control_motor_sm -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o MW_AnalogInput.o MW_PWM.o soc_stm_encoder.o xcp_ext_mode.o position_control_motor_sm.o position_control_motor_sm_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o mw_mbed_interface.o BufferedSerial.o blapp_support.o mbed_syscalls.o SysTickScheduler.o m3m4m4f_multitasking.o sys_arch.o xcp_platform_timer_mbed.o rtiostream_serial_mbed.o
...
LIBS = C:/ProgramData/MATLAB/SupportPackages/R2023b/3P.instrset/cmsis_dsp.instrset/Lib/GCC/arm_cortexm4ldfsp_math/libCMSISDSP.a
...
LDFLAGS_ = @E:\edc\EDC_Project_Work_Marsico_Zito\position_control\position_control_motor_sm_ert_rtw\mbed_objects.rsp
...
SHAREDLIB_LDFLAGS_ = @E:\edc\EDC_Project_Work_Marsico_Zito\position_control\position_control_motor_sm_ert_rtw\mbed_objects.rsp
...
CPP_LDFLAGS_ = @E:\edc\EDC_Project_Work_Marsico_Zito\position_control\position_control_motor_sm_ert_rtw\mbed_objects.rsp
...
CPP_SHAREDLIB_LDFLAGS_ = @E:\edc\EDC_Project_Work_Marsico_Zito\position_control\position_control_motor_sm_ert_rtw\mbed_objects.rsp
...
%.o : $(START_DIR)/position_control_motor_sm_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/position_control_motor_sm_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/position_control_motor_sm_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/position_control_motor_sm_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/position_control_motor_sm_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
soc_stm_encoder.o : E:/edc/EDC_Project_Work_Marsico_Zito/quadratureEncoder_module/src/soc_stm_encoder.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/position_control_motor_sm_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


position_control_motor_sm.o : $(START_DIR)/position_control_motor_sm_ert_rtw/position_control_motor_sm.c
	$(CC) $(CFLAGS) -o "$@" "$<"


position_control_motor_sm_data.o : $(START_DIR)/position_control_motor_sm_ert_rtw/position_control_motor_sm_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/position_control_motor_sm_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/position_control_motor_sm_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/position_control_motor_sm_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
mw_mbed_interface.o : C:/ProgramData/MATLAB/SupportPackages/R2023b/toolbox/target/supportpackages/stmnucleo/STM32F401RE/src/mw_mbed_interface.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
blapp_support.o : C:/ProgramData/MATLAB/SupportPackages/R2023b/toolbox/target/supportpackages/stmnucleo/src/blapp_support.c
	$(CC) $(CFLAGS) -o "$@" "$<"
