###########################################################################
## Makefile generated for component 'open_loop'. 
## 
## Makefile     : open_loop.mk
## Generated on : Wed Jul 17 14:46:47 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/open_loop.elf
...
COMPILER_COMMAND_FILE     = open_loop_comp.rsp
CMD_FILE                  = open_loop.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/open_loop.elf
...
DEFINES_STANDARD = -DMODEL=open_loop -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o MW_PWM.o soc_stm_encoder.o MW_AnalogInput.o xcp_ext_mode.o open_loop.o open_loop_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o mw_mbed_interface.o BufferedSerial.o blapp_support.o mbed_syscalls.o SysTickScheduler.o m3m4m4f_multitasking.o sys_arch.o xcp_platform_timer_mbed.o rtiostream_serial_mbed.o
...
LDFLAGS_ = @E:\edc\EDC_Project_Work_Marsico_Zito\position_model\open_loop_ert_rtw\mbed_objects.rsp
...
SHAREDLIB_LDFLAGS_ = @E:\edc\EDC_Project_Work_Marsico_Zito\position_model\open_loop_ert_rtw\mbed_objects.rsp
...
CPP_LDFLAGS_ = @E:\edc\EDC_Project_Work_Marsico_Zito\position_model\open_loop_ert_rtw\mbed_objects.rsp
...
CPP_SHAREDLIB_LDFLAGS_ = @E:\edc\EDC_Project_Work_Marsico_Zito\position_model\open_loop_ert_rtw\mbed_objects.rsp
...
%.o : $(START_DIR)/open_loop_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/open_loop_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/open_loop_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/open_loop_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/open_loop_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/open_loop_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


open_loop.o : $(START_DIR)/open_loop_ert_rtw/open_loop.c
	$(CC) $(CFLAGS) -o "$@" "$<"


open_loop_data.o : $(START_DIR)/open_loop_ert_rtw/open_loop_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/open_loop_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/open_loop_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/open_loop_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
